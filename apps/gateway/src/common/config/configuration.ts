...
import { MailSettings } from './settings/mail.settings';
import { DatabaseSettings } from '../../../../common/config/data-base.settings';
import { JwtSettings } from './settings/jwt.settings';
import { OauthSetting } from './settings/oauth.setting';
import { RecaptchaSettings } from './settings/recaptcha.settings';
import { FrontRedirectSettings } from './settings/front-redirect.settings';
import { StorageServiceSettings } from './settings/storage-service.settings';
